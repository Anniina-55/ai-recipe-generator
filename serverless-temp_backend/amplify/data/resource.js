...
// Määritellään GraphQL-skeema
var schema = backend_1.a.schema({
    BedrockResponse: backend_1.a.customType({
        body: backend_1.a.string(),
        error: backend_1.a.string(),
    }),
    askBedrock: backend_1.a.query()
        .arguments({ ingredients: backend_1.a.string().array() })
        .returns(backend_1.a.ref("BedrockResponse"))
        .authorization(function (allow) { return [allow.authenticated()]; })
        .handler(backend_1.a.handler.custom({
        entry: "./bedrock.js", // Tämä tiedosto tekee API-kutsun Bedrockiin
        dataSource: "bedrockDS",
    })),
});
// Määritellään data resurssiksi
